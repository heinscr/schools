...
**Year Format:**
- Years are stored in "YYYY-YYYY" format (e.g., "2024-2025")
- When extracting "2024-2025", we keep it as is: "2024-2025"
- When extracting "2023" (standalone), we convert to: "2023-2024"
- When extracting "July 1, 2027", we convert to: "2027-2028"
...
- What the current school year is (e.g., 2025-2026)
- Which years were selected (in YYYY-YYYY format)
