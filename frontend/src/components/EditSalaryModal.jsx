...
function AddColumnControl({ scheduleIdx, onAddColumn }) {
  ...
  return (
    <div style={{ display: 'flex', gap: '8px', alignItems: 'center', padding: '8px', backgroundColor: '#f8f9fa', borderRadius: '4px' }}>
      <span style={{ fontSize: '13px', fontWeight: '500' }}>Education:</span>
      <select
        value={education}
      ...
      <span style={{ fontSize: '13px', fontWeight: '500' }}>Credits:</span>
      <input
        type="number"
        min="0"
        step="12"
...
function AddStepControl({ scheduleIdx, existingSteps, onAddStep }) {
  ...
  return (
    <div style={{ display: 'flex', gap: '8px', alignItems: 'center', padding: '8px', backgroundColor: '#f8f9fa', borderRadius: '4px' }}>
      <span style={{ fontSize: '13px', fontWeight: '500' }}>Step:</span>
      <input
        type="number"
        min="1"
        value={stepNumber}
